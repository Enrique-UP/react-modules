$(".projects-list .item img").on("click", slide_show);
      function slide_show(){
      ...
      function prev(){
          $(".projects-list .item.current").each(function(){
      ...
      function slide_remove(){
          ...
          $(".projects-list .item").removeClass("current");
      };


      $(".slide_show > i.prev").on("click", function(){
          $(".slide_show > i.next").show();
          $('.projects-list').find('.item:first-child.current').each(function(){
      ...
      $(".slide_show > i.next").on("click", function(){
          $(".slide_show > i.prev").show();
          $('.projects-list').find('.item:last-child.current').each(function(){
              $(".slide_show > i.next").hide();
          });
      });


      $(".projects-list .item:first-child img").on("click", function(){
          $(".slide_show > i.next").show();
          $('.projects-list').find('.item:first-child.current').each(function(){
              $(".slide_show > i.prev").hide();
          });
      ...
      $(".projects-list .item:last-child img").on("click", function(){
          $(".slide_show > i.prev").show();
          $('.projects-list').find('.item:last-child.current').each(function(){
              $(".slide_show > i.next").hide();
          });
      ...
      var totalLi = $(".projects-list .item").length;
      //console.log("totalLi = " + totalLi);
      $(".slide_show .total_current .total").text(totalLi);
      $(".projects-list .item img, .slide_show > i.prev, .slide_show > i.next").on("click", function () {
          var index = $(".projects-list .item.current").index() + 1;
